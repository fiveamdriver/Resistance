...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2d558a] disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[#2d558a] text-[#F5F0E8] hover:bg-[#1e3d6b] shadow-[0_0_20px_rgba(45,85,138,0.25)]",
        outline:
          "border border-[#1a3252] bg-transparent text-[#F5F0E8] hover:bg-[#0a1628] hover:border-[rgba(45,85,138,0.4)]",
        ghost: "bg-transparent text-[#94a3b8] hover:bg-[#0a1628] hover:text-[#F5F0E8]",
        secondary:
